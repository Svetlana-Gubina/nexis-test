...
function __VLS_template() {
    ...
    // @ts-ignore
    const __VLS_6 = __VLS_asFunctionalComponent(__VLS_5, new __VLS_5({ id: ("description"), modelValue: ((__VLS_ctx.formData.description)), height: ("400px"), }));
    const __VLS_7 = __VLS_6({ id: ("description"), modelValue: ((__VLS_ctx.formData.description)), height: ("400px"), }, ...__VLS_functionalComponentArgsRest(__VLS_6));
    if (!!__VLS_ctx.errors.description) {
        // @ts-ignore
        [ErrorMessage, ErrorMessage,];
        // @ts-ignore
        const __VLS_11 = __VLS_asFunctionalComponent(ErrorMessage, new ErrorMessage({}));
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.input)({ ...{ onInput: (__VLS_ctx.handleDate) }, type: ("date"), id: ("published_from"), name: ("published_from"), value: ((new Date(__VLS_ctx.formData.published_from).toISOString().split('T')[0])), });
    if (!!__VLS_ctx.errors.published_from) {
        // @ts-ignore
        [ErrorMessage, ErrorMessage,];
        // @ts-ignore
        const __VLS_16 = __VLS_asFunctionalComponent(ErrorMessage, new ErrorMessage({}));
