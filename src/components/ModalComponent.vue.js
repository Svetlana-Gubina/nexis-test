...
const { defineSlots, defineExpose, defineModel, defineOptions, withDefaults } =
  await import("vue");
...
const target = ref(null); /* PartiallyEnd: #3632/scriptSetup.vue */
...
function __VLS_template() {
  ...
  if (__VLS_ctx.isOpen) {
    ...
    __VLS_elementAsFunction(
      __VLS_intrinsicElements.div,
      __VLS_intrinsicElements.div,
    )({ ...{ class: "modal-wrapper" }, ref: "target" });
    // @ts-ignore navigation for `const target = ref()`
    __VLS_ctx.target;
    __VLS_elementAsFunction(
      __VLS_intrinsicElements.div,
      __VLS_intrinsicElements.div,
    )({ ...{ class: "modal-container" }, ref: "target" });
    // @ts-ignore navigation for `const target = ref()`
    __VLS_ctx.target;
    __VLS_elementAsFunction(
